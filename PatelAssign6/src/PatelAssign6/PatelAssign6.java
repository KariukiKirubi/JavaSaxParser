...
* It reads the name and set number from the XML file provided using SAX parser, store the data
* in an array list, prompt the user to enter a term, then search the term based on the keyword, and displays
* all the elements that matches the keyword. 
***************************************************************************************************************/
...
public class PatelAssign6 extends DefaultHandler {
       ...
       public static void main(String[] args) throws IOException, SAXException,
              ...
              PatelAssign6 handler = new PatelAssign6();
